...
- 将发布版本固化为 **V2.2.9**（包管理版本为 `2.2.9`）
- 同步框架文档：[README.md](README.md)、[docs/FRAMEWORK.md](docs/FRAMEWORK.md)、[buildResources/README.md](buildResources/README.md)
- 同步根包、`server/`、`shared/` 的 `package.json` 与根 / `server/` 的 `package-lock.json` 根条目版本到 `2.2.9`（不改动第三方依赖如 `json5@2.2.3`）

## [2.2.8] - 2026-03-21

### 软件框架同步与版本固化

- 将发布版本固化为 **V2.2.8**（包管理版本为 `2.2.8`）
- 同步框架文档：[README.md](README.md)、[docs/FRAMEWORK.md](docs/FRAMEWORK.md)、[buildResources/README.md](buildResources/README.md)
- 同步根包、`server/`、`shared/` 的 `package.json` 与根 / `server/` 的 `package-lock.json` 根条目版本到 `2.2.8`（不改动第三方依赖如 `json5@2.2.3`）

## [2.2.7] - 2026-03-21

### 软件框架同步与版本固化

- 将发布版本固化为 **V2.2.7**（包管理版本为 `2.2.7`）
- 同步框架文档：[README.md](README.md)、[docs/FRAMEWORK.md](docs/FRAMEWORK.md)、[buildResources/README.md](buildResources/README.md)
- 同步根包、`server/`、`shared/` 的 `package.json` 与根 / `server/` 的 `package-lock.json` 根条目版本到 `2.2.7`（不改动第三方依赖如 `json5@2.2.3`）
...
- 将发布版本固化为 **V2.2.5**（包管理版本为 `2.2.5`）
- 更新 [README.md](README.md)、[docs/FRAMEWORK.md](docs/FRAMEWORK.md)、[buildResources/README.md](buildResources/README.md) 的版本标识
- 同步根包、`server/`、`shared/` 的 `package.json` 与根 / `server/` 的 `package-lock.json` 根条目版本到 `2.2.5`（不改动第三方依赖如 `json5@2.2.3`）

## [2.2.4] - 2026-03-21

### 文档更新与版本固化

- 将发布版本固化为 **V2.2.4**（包管理版本为 `2.2.4`）
- 更新 [README.md](README.md)、[docs/FRAMEWORK.md](docs/FRAMEWORK.md)、[buildResources/README.md](buildResources/README.md) 的版本标识
- 同步根包、`server/`、`shared/` 的 `package.json` 与根 / `server/` 的 `package-lock.json` 根条目版本到 `2.2.4`（不改动第三方依赖如 `json5@2.2.3`）
