...
**当前版本**: V2.2.4 · **文档/发布基准日**（本机系统日期）: 2026-03-21（周六） · **[变更日志](CHANGELOG.md)**
...
- `发现市场` 已切换为 provider 架构，不再依赖单一 `skills-index.json` 远程文件。
- 第一阶段默认接入 `ClawHub`，`SkillHub` 预留扩展位，后续可按相同协议接入。
